                ...
                <div class="blog-items">
                    <div class="blog-content col-md-8">
                        <div class="item">
                            ...
                            <!-- Start Post Thumb -->
                            <div class="thumb">
                                <img src="admin/dist/img/berita/<?php echo $ddetber['foto_berita_cover']; ?>" alt="Thumb">
                                <div class="post-type">
                            ...
                            <div class="info">
                                <div class="meta">
                                    <ul>
                                        ...
                                        <li><?php echo date('d/m/Y | H:i:s',$tglber),' WIB'; ?></li>
                                    </ul>
                                </div>
                                <h3><?php echo $ddetber['judul_berita']; ?></h3>
                                <!--DETAIL BERITA DISINI-->
                                    <?php echo $ddetber['isi_berita']; ?> 
