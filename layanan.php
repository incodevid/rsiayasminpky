                    ...
                    <div class="col-md-8 gallery-content">
                        ...
                        <div class="row magnific-mix-gallery text-center masonary">
                            <div id="portfolio-grid" class="gallery-items col-3">
                                ...
                                <?php
                                $katlay = $_GET[nm];  
                                $qlayan = mysqli_query($koneksi,"SELECT *,COUNT(a.id_layanan) AS jml_layan FROM tb_layanan a INNER JOIN tb_kategori_layanan b ON a.id_kategori_layanan=b.id_kategori_layanan WHERE nama_kategori='$katlay' GROUP BY a.id_layanan DESC");
