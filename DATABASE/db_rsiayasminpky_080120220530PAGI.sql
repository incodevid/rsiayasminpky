...
CREATE TABLE `tb_akun` (
  ...
  `level_akses` enum('super','admin','karyawan') DEFAULT NULL,
  PRIMARY KEY (`id_akun`)
...
INSERT INTO `tb_akun` VALUES (1,'Benny Sarmoko','Laki-Laki','benny.sarmoko27@gmail.com','2103187','IT','benny0852','123','super'),(2,'Kristanto','Laki-Laki','kristanto@gmail.com','2019001','Pemasaran dan Humas','kris123','123','admin'),(3,'Lisa Nazla, SP','Perempuan','example@gmail.com','1603124','Auditoring','lisa123','123','admin');
...
-- Dump completed on 2022-01-08  5:30:29
