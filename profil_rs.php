...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>RSIA Yasmin - Profil RS</title>
                ...
                <div class="blog-items">
                    <div class="blog-content col-md-8">
                        ...
                        <div class="single-item item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="admin/dist/img/profil_rs/<?php echo $dprofilrs['foto_cover']; ?>" alt="Thumb">
                                    <div class="post-type">
                            ...
                            <div class="info">
                                <div class="meta">
                                    <ul>
                                        <li><center><h2><a href="#">PROFIL RUMAH SAKIT</a></h2></center></li>
                                    </ul>
                                </div>
                                                            
                                    <?php echo $dprofilrs['text_profil_rs'];?>
