...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>RSIA Yasmin - Galeri</title>
                ...
                <div class="row">
                    <div class="col-md-12 gallery-content">
                        ...
                        <div class="mix-item-menu text-center">
                            ...
                            <?php 
                            $qalbum=mysqli_query($koneksi,"SELECT * FROM tb_album ORDER BY id_album DESC");
                            while($dalbum=mysqli_fetch_assoc($qalbum)){
                            ?>
                            <button data-filter=".<?php echo $dalbum['id_album']; ?>"><?php echo $dalbum['nama_album']; ?></button>
                        <?php } ?>
                        </div>
                         <!-- End Mixitup Nav-->
                        ...
                        <div class="row magnific-mix-gallery text-center masonary">
                            <div id="portfolio-grid" class="gallery-items col-3">
                                ...
                                <?php 
                                $qgaleri = mysqli_query($koneksi,"SELECT *,COUNT(a.id_galeri) AS jml_galer FROM tb_galeri a INNER JOIN tb_album b ON a.id_album=b.id_album GROUP BY a.id_galeri DESC");
                                while($dgaleri=mysqli_fetch_assoc($qgaleri)){
                                if($dgaleri['jml_galer']=='0'){
                                ?>
                                ...
                                <?php }else{ ?>
                                <!-- Single Item -->
                                <div class="pf-item <?php echo $dgaleri['id_album']; ?> capital">
                                    <div class="effect-box">
                                        <img src="admin/dist/img/galeri/<?php echo $dgaleri['file_foto']; ?>" alt="thumb">
                                        <div class="info">
                                          <h4><a href="#"><?php echo $dgaleri['nama_foto']; ?></a></h4>
                                          <a href="admin/dist/img/galeri/<?php echo $dgaleri['file_foto']; ?>" class="item popup-link"><i class="fa fa-eye"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Item -->
