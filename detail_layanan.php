...
$getdet2=$_GET[det];
$qdlayan=mysqli_query($koneksi,"SELECT * FROM tb_layanan WHERE nama_layanan='$getdet2' ");
$dlayan=mysqli_fetch_assoc($qdlayan);
...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>RSIA Yasmin - Detail Layanan</title>
                    ...
                    <div class="blog-content col-md-8">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <h3><?php echo $dlayan['nama_layanan']; ?></h3>
                                <!--DETAIL BERITA DISINI-->
                                    <?php echo $dlayan['deskripsi_layanan']; ?> 
